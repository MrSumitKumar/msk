...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className={`relative rounded-2xl overflow-hidden shadow-lg border group transition-all duration-300 hover:scale-[1.02] hover:shadow-xl ${
        theme === 'dark'
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          ...
          <span className={`px-3 py-1 rounded-full text-xs font-medium ${
            theme === 'dark'
              ? course.course_type === 'COMBO' ? 'bg-yellow-900 text-yellow-200' : 'bg-green-900 text-green-200'
              : course.course_type === 'COMBO' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
          }`}>
            {course.course_type === 'COMBO' ? 'Combo Course' : 'Single Course'}
          </span>
