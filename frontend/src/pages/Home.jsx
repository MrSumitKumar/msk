...
import { Rocket, BookOpenCheck, GraduationCap, ArrowRight, Play, Users, Award, BookOpen } from "lucide-react";
      ...
      <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <section className={`py-20 transition-colors duration-300 ${
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className={`p-8 rounded-2xl text-center transition-all duration-300 hover:transform hover:scale-105 ${
                theme === 'dark' 
                ...
                <div className={`w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center transition-colors duration-300 ${
                  ...
                  <Rocket className={`w-8 h-8 transition-colors duration-300 ${
                    theme === 'dark' ? 'text-blue-400' : 'text-blue-600'
                  }`} />
                </div>
              ...
              <div className={`p-8 rounded-2xl text-center transition-all duration-300 hover:transform hover:scale-105 ${
                ...
                <div className={`w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center transition-colors duration-300 ${
                  ...
                  <BookOpenCheck className={`w-8 h-8 transition-colors duration-300 ${
                    theme === 'dark' ? 'text-green-400' : 'text-green-600'
                  }`} />
                </div>
                <h3 className={`text-xl font-bold mb-4 transition-colors duration-300 ${
        ...
        <section className={`py-20 transition-colors duration-300 ${
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className={`text-3xl lg:text-4xl font-bold mb-8 transition-colors duration-300 ${
              theme === 'dark' ? 'text-white' : 'text-gray-900'
            }`}>
        ...
        {/* Call to Action */}
        <section className={`py-24 lg:py-32 text-center transition-colors duration-300 ${
          theme === 'dark' 
            ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white' 
            : 'bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 text-gray-900'
        }`}>
          <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
            <h2 className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-8 leading-tight transition-colors duration-300 ${
              theme === 'dark' ? 'text-white' : 'text-gray-900'
            }`}>
              Ready to Start Your Learning Journey?
            </h2>
            <p className={`text-xl sm:text-2xl lg:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed transition-colors duration-300 ${
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                to="/register"
                className={`inline-flex items-center justify-center px-10 py-5 rounded-xl text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-xl min-w-[200px] ${
                  theme === 'dark' 
              ...
              <Link
                to="/contact"
                className={`inline-flex items-center justify-center px-10 py-5 rounded-xl text-xl font-bold border-3 transition-all duration-300 transform hover:scale-105 min-w-[200px] ${
                  theme === 'dark' 
